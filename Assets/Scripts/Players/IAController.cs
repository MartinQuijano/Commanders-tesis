...
public class IAController : MonoBehaviour
{
    ...
    public List<CharacterInfo> charactersWithActions;
    ...
    void Update()
    {
        if (charactersWithActions.Count > 0)
        {
            if (canTakeAnAction)
            {
                ...
                CharacterInfo enemyInRangeOfAttack = FindOneEnemyInRange(tilesInRangeOfAttack);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (enemyInRangeOfAttack == null && !selectedCharacter.moved)
                        {
                            ...
                            selectedCharacter.MoveAlongPathForIATest(path);
                        }
                        else
                        {
    ...
    private CharacterInfo FindOneEnemyInRange(List<OverlayTile> tilesInRangeOfAttack)
    {
        bool enemyFound = false;
        CharacterInfo enemy = null;
    ...
    {
        foreach (CharacterInfo character in myTeam.characters)
        {
